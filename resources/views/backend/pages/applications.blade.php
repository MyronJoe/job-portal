                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-1">
                                            <img src="../../../assets/frontend/uploads/{{$job->company_logo}}" alt="image" />
                                        </td>
                                        ...
                                        <!-- <td>
                                            <a onclick="confirmation(event)" href="{{route('delete_category', $job->id)}}" class="badge badge-outline-danger">Delete</a>
                                        </td> -->
                                    </tr>
