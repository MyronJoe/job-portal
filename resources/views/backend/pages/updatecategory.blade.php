            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{route('update_category', $data->id)}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="category" id="exampleInputcategory1" placeholder="category" style="color: white;" value="{{$data->category}}">
                            </div>
