...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; background-color:#F8FBF1; padding:15px; border-radius:6px; margin-bottom:15px ">
            ...
            <a href="{{route('view_message', $message->id)}}" class="p">{{$message->message}}</a>



            <a onclick="confirmation(event)" class="btn btn-light" href="{{route('delete_message', $message->id)}}"><i class="fa fa-trash text-primary"></i></a>
